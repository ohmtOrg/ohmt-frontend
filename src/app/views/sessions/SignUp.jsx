...
const suggestions = countriesjson.filter(
...
class SignUp extends Component {
  state = {
    ...
    // subRegion: "",
    gender: "",
    creationDate: new Date("2021-06-18T21:11:54"),
    otherInfo: "",
    platformName: "",
    section: "",
    assesmentDate: new Date("2021-06-18T21:11:54"),
  };

  handleChange = (event, newValue, field) => {
        ...
        <div className="signup flex justify-center">
          <div className="p-8">
            <Card className="signup-card position-relative y-center">
              <Grid container>
                <Grid item lg={12} md={5} sm={5} xs={12}>
