...
const guidance= [
    ...
    },
    {
      ...
      description: "The scoring scare is 1 to 4. The individual (s) conducting the self-assessment assigns scores into the OHMT scoring grid , by assigning a score  to each of the 26 sub-categories. The meaning of each score are.scoring 1:it means No initiative is in place for implementing OH, Scoring 2:it means Plans are in place to develop initiatives that will improve OH, scoring 3: it means OH implementation is ongoing but initiatives/activities are not yet endorsed by relevant competent authorities and scoring 4 means OH implemtation is ongoing and initiatives/activities are endorsed by relevant competent authorities. Based on the scores entered into the OHMT scoring grid, graphs highlighting the institutionalization and operationalization system’s strengths and weaknesses are automatically generated. These outputs become the basis from which guidance for improvement are proposed.",
