export const goverd = [{
  ...
  scores: ['There is no plan to create/develop an entity that will conduct a multisectoral oversight for OH implementation',
    ...
    'There is an entity mandated to conduct multisectoral oversight for OH implementation but not legally eastablished',
  ...
  qs: [
    ...
    '1. Is there an MOU signed between relevant institutions establishing the national and sub-national cordination mechanism? <br/> 2.Is there an exectutive decision establishing the national coordination mechanism (Cabinet decision, ministerial instruction etc)',
  ]
},
{
...
},
{
  ...
  scores: ['The country has any 0 or 1 of the following 3 policies in place. 1 a policy on environmental health that speaks to issues of the health of animals and people arising from the environment and  2 a policy on human health that speaks to issues of the health of people   arising from the animals and environment 3a policy on animal health that speaks to issues of the health of animals  arising from the environment; the impacts of animals and thier health on the public and environmental health ',
    'The country has 1 a policy on environmental health that speaks to issues of the health of animals and people arising from the environment and  2 a policy on human health that speaks to issues of the health of people   arising from the animals and environment 3a policy on animal health that speaks to issues of the health of animals  arising from the environment; the impacts of animals and thier health on the public and environmental health 4 all the 3 policies have explicitly called for  multisectoral collaboration at the environment-animal-human interface',
    'The country has 1 a policy on environmental health that speaks to issues of the health of animals and people arising from the environment and  2 a policy on human health that speaks to issues of the health of people   arising from the animals and environment 3a policy on animal health that speaks to issues of the health of animals  arising from the environment; the impacts of animals and thier health on the public and environmental health 4 not all the 3 policies have explicitly called for  multisectoral collaboration at the environment-animal-human interface',
    'The country has 1 a policy on environmental health that speaks to issues of the health of animals and people arising from the environment and  2 a policy on human health that speaks to issues of the health of people   arising from the animals and environment 3a policy on animal health that speaks to issues of the health of animals  arising from the environment; the impacts of animals and thier health on the public and environmental health 4 all the 3 policies have explicitly called for  multisectoral collaboration at the environment-animal-human interface'],
  qs: [
    '',
    '',
...

{
  ...
  scores: ['The country has developed at less than 50% of the following policies/strategies or the exisitng strategies are single sector 1. multisectoral AMR policy/national action plan and 2. strategies or policies for prioritised zoonotic diseases and 3. multisectoral food safety strategy/plan and 4. multisectoral pesticides/chemical policy ',
    'The country has developed at least 50% of the following policies/strategies 1. multisectoral AMR policy/national action plan and 2. strategies or policies for prioritised zoonotic diseases and 3. multisectoral food safety strategy/plan and 4. multisectoral pesticides/chemical policy',
    'The country has developed at least 75% of the following policies/strategies 1. multisectoral AMR policy/national action plan and 2. strategies or policies for prioritised zoonotic diseases and 3. multisectoral food safety strategy/plan and 4. multisectoral pesticides/chemical policy ',
    'The country has 1. an AMR policy/national action plan  that address public health, animal health, plant health, aqauaculture and environmental health prioirty issues and 2. has prioritised zoonotic diseases and developed multisectoral strategies and implementation plans for each of them and 3.multisectoral food safety strategy/plan and 4. multisectoral pesticides/chemical policy']
  ,
  qs: [
    '',
    '',
...
},
{
  ...
  scores: ['There is no  plan to creta/develop legislation to support a OH implementation framework ',
    ...
    'There is legislation to support multi-sectoral OH implementation framework  but not yet endorsed by a relevant competent entity (public health, animal health, environment and wildlife sectors)',
...
},
{
  ...
  qs: [
    ...
    'Is there an MOU signed between relevant institutions establishing the financing mechanism for OH? <br/> 2.Is there an exectutive decision establishing the national coordination mechanism (Cabinet decision, ministerial instruction etc) ',
  ]
},
{
  ...
  scores: ['There is no plan to create/develop a framework for coordinating partners ',
    'There is a plan to create/develop a framework for partner coordinationion ',
...
{
  name: "Plan to disseminate and use M&E information",
  feedback: '', id: 132, value: 1,
  scores: ['There is no plan to disseminate and use M&E information',
    'There is a plan to disseminate and use M&E information ',
...
export const implemData = [
  {
    ...
    scores: [
      ...
      'There is a multi-sectoral interagency strategic document that stipulates implementation strategies, timelines and responsibilities for each sector but not yet endorsed by competent authorities ',
...

  {
    ...
    scores: [
      ...
      ' There is a workforce needs asessment that has been conducted and the report is report not endorsed',
  ...
  },
  {
    ...
    scores: [
      ...
      'There is a multidisciplinary training program established  addressing the gaps as identified by the need assessment',
  ...
  },
  {
    ...
    feedback: '',
    scores: ['There is  no plan to set-up a certification programs for in-service continuous professional training',
      'There is a plan to set-up a certification programs for in-service continuous professional training',

      'There are programs for in-service continuous professional training not yet accredited by competent authorities ',
  ...
  },
  {
    ...
    scores: ['There is no plan to develop a national research agenda on OH issues ',
      'There is a plan to develop a national research agenda on OH issues ',
      'There is a national research agenda on OH related issues ',
  ...
  },
  {
    ...
    scores: ['There is no  list of  priority zoonotic diseases identified and endorsed by competent authorities',
      ...
      'There is a budget available to implement the plan to address priority zoonotic diseases that were identified and endorsed by competent authorities'
    ]
    ,
    qs: [
      '',
